...
Route::get('players/ranking/winner', [GameController::class, 'getWinner'])->name('api.players.getWinner');

Route::get('players/ranking/loser', [GameController::class, 'getLoser'])->name('api.players.getLoser');
